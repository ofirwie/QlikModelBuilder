---
id: backend-004
title: Update detectIncrementalField to use name patterns only
status: todo
priority: medium
tags:
- backend
...
- backend-003
assignee: developer
created: 2026-01-15T23:07:08.094653100Z
estimate: ~
complexity: 3
area: backend
---

# Update detectIncrementalField to use name patterns only
